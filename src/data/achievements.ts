...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  },
  {
    id: "growth_seeker",
    name: "Growth Seeker",
    description: "Collect 100 energy with Dr. Maya",
    icon: "🌿",
    agentId: "coach",
    constellation: { name: "The Mindful", relatedSources: ["chat", "emotion"] },
    condition: { type: "energy_bits", agentId: "coach", threshold: 100 },
  },
  {
    id: "breakthrough",
    name: "Breakthrough",
    description: "Complete 20 conversations with Dr. Maya",
    icon: "💡",
    agentId: "coach",
    constellation: { name: "The Breakthrough", relatedSources: ["chat"] },
    condition: { type: "total_turns", agentId: "coach", threshold: 20 },
  },
  {
    id: "trail_companion",
